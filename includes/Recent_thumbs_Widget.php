...
class Recent_thumbs_Widget extends WP_Widget {
    ...
    function form($instance) {
        ...
        $defaults = array('title' => __('Recent Post', 'recent-thumbs-widget'), 'page' => '', 'qty' => 5);
        ...
        <p>
            ...
            <select id="<?php echo $this->get_field_id('page'); ?>" name="<?php echo $this->get_field_name('page'); ?>" style="width:100%;" >
