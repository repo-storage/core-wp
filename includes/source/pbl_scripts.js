...
function bl_keydown(e) {
    ...
    if (target == 'html' || target == 'body') {
        ...
        if (e.keyCode == '27') { // x close
            bl_setPanelSize('close');

        }else if (e.keyCode == '49') { //1 console
            bl_debug_set_panel('msg');

        }else if (e.keyCode == '50') {//2 sql
            bl_debug_set_panel('sql');

        }else if (e.keyCode == '51') {//3 vars
            bl_debug_set_panel('vars');

        }else if (e.keyCode == '52') {//4 time
            bl_debug_set_panel('time');

        }else if (e.keyCode == '53') {//5 memory
            bl_debug_set_panel('memory');

        }else if (e.keyCode == '54') {//6 ajax
            bl_debug_set_panel('ajax');

        }else if (e.keyCode == '55') {//7 php
            bl_debug_set_panel('php');

        }else if (e.keyCode == '56') {//8 bookmark
            bl_toggle('bl_tool_box');

        }else if (e.keyCode == '57') {//9 opacity
            bl_opacity();

        }else if (e.keyCode == '48') {//0 info
            bl_debug_set_panel('info');

        }else if (e.keyCode == '77') {// + maximizar
